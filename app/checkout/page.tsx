...
import { ArrowLeft, CreditCard, Smartphone, CheckCircle, XCircle, Clock } from 'lucide-react';
...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    // Simular busca dos dados do agendamento
    // Na implementação real, você buscaria do banco de dados
    const mockData: AppointmentData = {
      id: searchParams.get('appointment_id') || '123',
      serviceName: searchParams.get('service') || 'Corte de Cabelo',
      professionalName: searchParams.get('professional') || 'João Silva',
      price: parseFloat(searchParams.get('price') || '50'),
      customerName: searchParams.get('customer') || 'Cliente',
      customerEmail: searchParams.get('email') || 'cliente@email.com',
      salonName: searchParams.get('salon') || 'Barbearia Estilo',
      appointmentDate: searchParams.get('date') || '2024-01-15',
      appointmentTime: searchParams.get('time') || '14:00'
    };
